...
namespace biblioteca_app.CLASES
{
    public class Categoria
    {
        ...
        // Constructor
        public Categoria(string auxNombre, string auxDescripcion)
        {
            Nombre = auxNombre;
            Descripcion = auxDescripcion;
        }

        // Método para guardar categoría en BD usando procedimiento almacenado
        public int Save_Categoria()
        {
            ...
            object resultado = SqlHelper.ExecuteScalar(connString, CommandType.StoredProcedure, "save_categoria", Parametros);
