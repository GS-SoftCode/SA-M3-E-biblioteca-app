<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reserva-Form.aspx.cs" Inherits="biblioteca_app.Reserva_Form" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="header">
                ...
                <p>Administración de reservas del sistema de biblioteca</p>
            </div>
            
            <div class="form-content">
                <h2 class="form-title">Reservas</h2>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="txtFechaFin">Fecha Fin <span class="required">*</span></label>
                        ...
                        <asp:RequiredFieldValidator ID="rfvFechaFin" runat="server" 
                            ...
                            ErrorMessage="La fecha fin es obligatoria" 
                            ForeColor="#e74c3c" 
                            Display="Dynamic">
                        </asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlEstado" runat="server" CssClass="form-control">
                            <asp:ListItem Value="Activa" Selected="True">Activa</asp:ListItem>
                ...
                <div class="grid-container">
                    <asp:GridView ID="gvReservas" runat="server" CssClass="grid-view" AutoGenerateColumns="False" 
                        DataKeyNames="id_reserva" OnSelectedIndexChanged="gvReservas_SelectedIndexChanged">
                        <Columns>
